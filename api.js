...
(function (global) {
  ...
  var Results = {
    ...
    getClassAllocation:      function (c, a) { return get('/results/allocations/class' + buildQuery({ class: c, arm: a })); },
    getByClass:              function (c, a, p) { return get('/results' + buildQuery(Object.assign({ class: c, arm: a }, p || {}))); },
    setClassAllocation:      function (c, a, subs) { return put('/results/allocations/class' + buildQuery({ class: c, arm: a }), { subjects: subs }); },
    clearClassAllocation:    function (c, a) { return del('/results/allocations/class' + buildQuery({ class: c, arm: a })); }, getStudentAllocation:    function (id) { return get('/results/allocations/student/' + id); },
